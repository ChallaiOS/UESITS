...
public class RecycleHindiAdapter extends RecyclerView.Adapter<RecycleHindiAdapter.MyViewHolder> implements Serializable {

    Context context;
    List<itemModel> arrayList;

    public RecycleHindiAdapter(Context context, List<itemModel> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.hin_item_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, HindiContentActivity.class);
                Bundle b = new Bundle();

...
public class EnglishContentActivity extends AppCompatActivity implements View.OnTouchListener,GestureDetector.OnGestureListener {
...
//
        ...
        this.gestureDetector = new GestureDetector(EnglishContentActivity.this,this);
                ...
                if(Math.abs(valueX)>MIN_DISTANCE){
                    if (x2>x1){
                        ...
                        if (currentID >1){
                            ...
                            itemModel str = MySingleTon.getInstance().arrayList2.get(currentID - 1);
...
//                            getSupportActionBar().setDisplayShowTitleEnabled(true);
                            ...
                            currentID = MySingleTon.getInstance().arrayList2.size();
                            itemModel str = MySingleTon.getInstance().arrayList2.get(currentID - 1);
                            textView.setText(str.getLocal_text());
                            sharecumTitle.setText(str.getLocal_id() + "." + str.getLocal_title());
                        ...
                        this.textView.bringPointIntoView(0);
                        if (currentID > 0){
                            if (currentID == MySingleTon.getInstance().arrayList2.size()) {
                                currentID = 1;
                            }
                            else{
                                currentID = currentID + 1;

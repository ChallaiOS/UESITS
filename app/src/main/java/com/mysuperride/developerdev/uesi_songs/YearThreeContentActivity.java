...
public class YearThreeContentActivity extends AppCompatActivity implements View.OnTouchListener,GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year_three_content);
...
//        });
        ...
        this.gestureDetector = new GestureDetector(YearThreeContentActivity.this,this);
                ...
                if(Math.abs(valueX)>MIN_DISTANCE){
                    if (x2>x1){
                        ...
                        if (currentID >1){
                            ...
                            itemModel str = MySingleTonSS.getInstance().arrayListSS3.get(currentID - 1);
                            ...
                            currentID = MySingleTonSS.getInstance().arrayListSS3.size();
                            itemModel str = MySingleTonSS.getInstance().arrayListSS3.get(currentID - 1);
                            textView.setText(str.getLocal_text());
                            //sharecumTitle.setText(str.getLocal_id() + "." + str.getLocal_title());
                            sharecumTitle.setText(str.getLocal_title());
                        ...
                        this.textView.bringPointIntoView(0);
                        if (currentID > 0){
                            if (currentID == MySingleTonSS.getInstance().arrayListSS3.size()) {
                                currentID = 1;
                            }
                            else{
                                currentID = currentID + 1;

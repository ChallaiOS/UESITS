...
public class RecycleViewAdapter  extends RecyclerView.Adapter<RecycleViewAdapter.MyViewHolder> implements Serializable {

    Context context;
    List<itemModel> arrayList;

    public RecycleViewAdapter(Context context, List<itemModel> arrayList) {
       ...
       final itemModel itemmodel = arrayList.get(i);
        ...
        myViewHolder.relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, TeluguContentActivity.class);
                Bundle b = new Bundle();

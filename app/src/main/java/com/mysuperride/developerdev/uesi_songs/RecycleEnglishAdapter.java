...
public class RecycleEnglishAdapter  extends RecyclerView.Adapter<RecycleEnglishAdapter.MyViewHolder> implements Serializable {

    Context context;
    List<itemModel> arrayList;

    public RecycleEnglishAdapter(Context context, List<itemModel> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.eng_item_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, EnglishContentActivity.class);
                Bundle b = new Bundle();
                b.putSerializable("user2", itemmodel);

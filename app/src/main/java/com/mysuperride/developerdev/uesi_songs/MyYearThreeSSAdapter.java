...
public class MyYearThreeSSAdapter extends RecyclerView.Adapter<MyYearThreeSSAdapter.MyViewHolder> implements Serializable {

    Context context;
    List<itemModel> arrayList;

    public MyYearThreeSSAdapter(Context context, List<itemModel> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.three_item_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, YearThreeContentActivity.class);
                Bundle b = new Bundle();
                b.putSerializable("user3", itemmodel);

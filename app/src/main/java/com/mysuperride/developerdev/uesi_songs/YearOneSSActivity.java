...
public class YearOneSSActivity extends AppCompatActivity
    ...
    Context context;
    JSONObject object;
    private static final String TAG = YearOneSSActivity.class.getSimpleName();
    RecyclerView recyclerView;
    MyYearOneSSAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year_one_ssactivity);
...
//                pay.setVisibility(View.VISIBLE);
            ...
            JSONArray array1 = object.getJSONArray("yearone");
            ...
            for (int i = 0; i < array1.length(); i++) {
                ...
                MySingleTonSS.getInstance().arrayOfYearOneList = model;
                MySingleTonSS.getInstance().arrayListSS1 = arrayList1;
        ...
        adapter = new MyYearOneSSAdapter(getApplicationContext(), arrayList1);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch(id){
            ...
            case R.id.nav_telugu:
                Intent intent1 = new Intent(YearOneSSActivity.this, MainActivity.class);
                startActivity(intent1);
                break;

            case R.id.nav_english:
                Intent intent2 = new Intent(YearOneSSActivity.this, EngSongsActivity.class);
                startActivity(intent2);
                break;


            case R.id.nav_hindi:
                Intent intent3 = new Intent(YearOneSSActivity.this, HinSongsActivity.class);
                startActivity(intent3);
                break;

            case R.id.nav_special:
                Intent intent4 = new Intent(YearOneSSActivity.this, SpecialSongsActivity.class);
                startActivity(intent4);
                break;

            case R.id.nav_share:
                Intent intent5 = new Intent(YearOneSSActivity.this, ShareActivity.class);
                startActivity(intent5);
                break;

            case R.id.nav_contactus:
                Intent intent6 = new Intent(YearOneSSActivity.this, ContactUsActivity.class);
                startActivity(intent6);
                break;
            case R.id.nav_aboutus:
                Intent intent7 = new Intent(YearOneSSActivity.this, AboutUsActivity.class);
                startActivity(intent7);
                break;

            case R.id.nav_terms:
                Intent intent8 = new Intent(YearOneSSActivity.this, TermsCondtionsActivity.class);
                startActivity(intent8);
                break;
            case R.id.nav_privacy:
                Intent intent9 = new Intent(YearOneSSActivity.this, PrivacyPolicyActivity.class);
                startActivity(intent9);
                break;
            case R.id.nav_feedback:
                Intent intent10 = new Intent(YearOneSSActivity.this, FeedbackActivity.class);
                startActivity(intent10);
                break;

            case R.id.introduction:
                Intent intent11 = new Intent(YearOneSSActivity.this, IntroductionSSActivity.class);
                startActivity(intent11);
                break;

            case R.id.first_year:
                Intent intent12 = new Intent(YearOneSSActivity.this, YearOneSSActivity.class);
                startActivity(intent12);
                break;

            case R.id.second_year:
                Intent intent13 = new Intent(YearOneSSActivity.this, YearTwoSSActivity.class);
                startActivity(intent13);
                break;

            case R.id.third_year:
                Intent intent14 = new Intent(YearOneSSActivity.this, YearThreeActivity.class);

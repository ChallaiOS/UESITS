...
public class TeluguContentActivity extends AppCompatActivity implements View.OnTouchListener,GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_telugu_content);
        ...
        if (isFirstRun) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(TeluguContentActivity.this);
...
//                            startActivity(intent1);
        ...
        sharecumTitle.setOnClickListener(new View.OnClickListener() {
         ...
         this.gestureDetector = new GestureDetector(TeluguContentActivity.this,this);
                ...
                if(Math.abs(valueX)>MIN_DISTANCE){
                    if (x2>x1){
                        ...
                        if (currentID >1){
                            ...
                            itemModel str = MySingleTon.getInstance().arrayList1.get(currentID - 1);
                            textView.setText(str.getLocal_text());
//                            textView.setText(user.getLocal_text());
                            sharecumTitle.setText(str.getLocal_id() + "." + str.getLocal_title());
                        }
                        else{
                            currentID = MySingleTon.getInstance().arrayList1.size();
                            itemModel str = MySingleTon.getInstance().arrayList1.get(currentID - 1);
                            textView.setText(str.getLocal_text());
//                            textView.setText(user.getLocal_text());
                            sharecumTitle.setText(str.getLocal_id() + "." + str.getLocal_title());
                        ...
                        this.textView.bringPointIntoView(0);
                        if (currentID > 0){
                            if (currentID == MySingleTon.getInstance().arrayList1.size()) {
                                currentID = 1;
                            }
                            else{
                                currentID = currentID + 1;

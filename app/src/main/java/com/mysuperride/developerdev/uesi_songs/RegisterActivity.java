...
import static com.mysuperride.developerdev.uesi_songs.LoginActivity.globalPreferenceName;
...
public class RegisterActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,PaymentResultListener {
    ...
    String money = "Choose your Donation Amount";
...
//                }
                ...
                if(!Patterns.EMAIL_ADDRESS.matcher(email).matches()){
                    ...
                    mDialog = new SimpleArcDialog(RegisterActivity.this);
                    mDialog.setConfiguration(new ArcConfiguration(RegisterActivity.this));
...
//                        overridePendingTransition(0,0);
    ...
    private void initDefaultHintSpinner() {
        ...
        defaults.add(String.format(VALUE_STRING, 10000));
...
//        }
    ...
    private void initiatepaymentCashFree() {
      ...
      /*progressDialog=new ProgressDialog(LoginActivity.this);
        ...
        retrofit2.Call<DefaultResponse> call = service.getToken(money, "order123455");
            ...
            public void onResponse(Call<DefaultResponse> call, Response<DefaultResponse> response) {
                if (response.isSuccessful()) {
                    if (response.body().getMessage().equals("Token generated")){
                        ...
                        params.put(PARAM_ORDER_AMOUNT, money);
                        params.put(PARAM_ORDER_NOTE, "UESI SONGS");
                        params.put(PARAM_CUSTOMER_NAME,user);
                        params.put(PARAM_CUSTOMER_PHONE, mobile);
                        ...
                        cfPaymentService.doPayment(RegisterActivity.this, params, token, "PROD", "#F8A31A", "#FFFFFF", false);
                    }else{
                        Toast.makeText(RegisterActivity.this, "msg2"+response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }else {
                    Toast.makeText(RegisterActivity.this, "msg3"+response.body().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call<DefaultResponse> call, Throwable t) {

                Toast.makeText(RegisterActivity.this, "msg4"+t.getMessage(), Toast.LENGTH_SHORT).show();
        ...
        call.enqueue(new Callback<DefaultResponse>() {
            ...
            public void onResponse(Call<DefaultResponse> call, Response<DefaultResponse> response) {
                ...
                if (response.code() == 200){
                    ...
                    editor.putString("donation_key","DonationDone");
...
//                        builder.setMessage("Payment Success....Downloaded all songs")
//                                .setCancelable(false)
...
//                    }
    ...
    public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Toast.makeText(RegisterActivity.this,adapterView.getSelectedItem().toString(),Toast.LENGTH_LONG).show();
        mDialog.hide();

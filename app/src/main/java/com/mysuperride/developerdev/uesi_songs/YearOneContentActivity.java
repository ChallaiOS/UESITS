...
public class YearOneContentActivity extends AppCompatActivity implements View.OnTouchListener,GestureDetector.OnGestureListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_year_one_content);
        ...
        if (isFirstRun) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(YearOneContentActivity.this);
            builder.setMessage("Tap on title for sharing song")
                    .setCancelable(false)
                    .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {

//                            Intent intent1 = new Intent(TeluguContentActivity.this, MainActivity.class);
...
//        });
        ...
        this.gestureDetector = new GestureDetector(YearOneContentActivity.this,this);

        Intent i = getIntent();
        Bundle bundle = i.getExtras();
        user = (itemModel) bundle.getSerializable("user");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.song_share:
                ...
                String app_url = "Search the Scriptures Android App:\n https://play.google.com/store/apps/details?id=com.mysuperride.developerdev.searchscriptures\n";
                shareIntent.putExtra(android.content.Intent.EXTRA_TEXT,app_url);
                startActivity(Intent.createChooser(shareIntent, "Share via"));
                break;
        }
                ...
                if(Math.abs(valueX)>MIN_DISTANCE){
                    if (x2>x1){
                        ...
                        if (currentID >1){
                            ...
                            itemModel str = MySingleTonSS.getInstance().arrayListSS1.get(currentID - 1);
...
//                            sharecumTitle.setText(str.getLocal_id() + "." + str.getLocal_title());
                            ...
                            currentID = MySingleTonSS.getInstance().arrayListSS1.size();
                            itemModel str = MySingleTonSS.getInstance().arrayListSS1.get(currentID - 1);
                            textView.setText(str.getLocal_text());
//                            textView.setText(user.getLocal_text());
//                            sharecumTitle.setText(str.getLocal_id() + "." + str.getLocal_title());
                        ...
                        this.textView.bringPointIntoView(0);
                        if (currentID > 0){
                            if (currentID == MySingleTonSS.getInstance().arrayListSS1.size()) {
                                currentID = 1;
                            }
                            else{
                                currentID = currentID + 1;
...
//                            sharecumTitle.setText(str.getLocal_id() + "." + str.getLocal_title());
        ...
        if (event.getPointerCount() == 2) {
            TextView viewById = (TextView) findViewById(R.id.textContent1);

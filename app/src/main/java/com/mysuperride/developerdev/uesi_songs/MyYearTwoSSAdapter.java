...
public class MyYearTwoSSAdapter  extends RecyclerView.Adapter<MyYearTwoSSAdapter.MyViewHolder> implements Serializable {

    Context context;
    List<itemModel> arrayList;

    public MyYearTwoSSAdapter(Context context, List<itemModel> arrayList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.two_item_list,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
        ...
        myViewHolder.relative.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, YearTwoContentActivity.class);
                Bundle b = new Bundle();
